      ...
      messages: [
        {
          ...
          content:
            `
            You are a prompt enhancement specialist. The user wants to make changes to their 
            website. Enhance their request to be more specific and actionable for a web developer.
      ...
      messages: [
        {
          ...
          content:
            ...
            - Make sure it's a complete, standalon HTML document with Tailwind CSS
...
export const rollbackToVersion = async (req: Request, res: Response) => {
  ...
  try {
    ...
    // ✅ FIX: update only by unique field (id)
    await prisma.websiteProject.update({
      where: {
        id: projectId,
      },
