...
const steps = [
    {icon: ScanLineIcon, label: "Analyzin your request..."},
...
const LoaderSteps = () => {
    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white">
            <div className="absoulte inset-0 bg-linear-to-br from-blue-500/10 via-purple-500/10 to-funchsia-500/10 blur-3xl animate-pulse"></div>
