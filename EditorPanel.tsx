...
const EditorPanel = ({selectedElement, onUpdate, onClose}: EditorPanelProps) => {
    ...
    return (
        <div className="absolute top-4 right-4 w-80 bg-white rounded-lg shadow-xl border border-gray-200 p-4 z-50 animate-face-in fade-in">
        ...
        <div className="space-y-4 text-black">
            ...
            <div className="gird grid-cols-2 gap-3">
                <div>
                    <label className="block text=xs fontmedium text-gray-500 mb-1">Padding</label>
                ...
                <div>
                    <label className="block text=xs fontmedium text-gray-500 mb-1">Margin</label>
            ...
            <div className="gird grid-cols-2 gap-3">
                <label className="block text=xs fontmedium text-gray-500 mb-1">Font Size</label>
            ...
            <div className="gird grid-cols-2 gap-3">
                <label className="block text=xs fontmedium text-gray-500 mb-1">Background</label>
                ...
                <div>
                    <label className="block text=xs fontmedium text-gray-500 mb-1">Text Color</label>
